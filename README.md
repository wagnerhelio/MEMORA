...
Perform 
# Projeto Perfom
POC de Gestão de Contratos e Relatorios e Dashbords integrados
...
```bash
git clone https://github.com/wagnerhelio/MEMORA.git
...
![Arquitetura Memora.drawio](static/img/Arquitetura%20Memora.drawio.png)

## 📬 Contato
Contribuições, sugestões e correções são bem-vindas!
Entre em contato wagner.filho@memora.com
